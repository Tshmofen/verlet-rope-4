...
| `Vector3 GetParticlePosition(int)` | Retrieves current position of a particle by index, supports negative indexes. Returns `Vector3.Zero` when there is no such particle. |
